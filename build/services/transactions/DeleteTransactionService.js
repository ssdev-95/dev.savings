...
var DeleteTransactionService = /** @class */ (function () {
    ...
    DeleteTransactionService.prototype.execute = function (transaction_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, firebase_1.database.collection('transactions').doc(transaction_id).delete()];
                    case 1:
                        _a.sent();
